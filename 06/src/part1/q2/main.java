...
class main{
    public static void main(String[] args){
        ...
        //Declaration Test
        HashtableDoubleCoalesced<Integer,String> table = new HashtableDoubleCoalesced();
        ...
        for(int i = 0; i<5;i++){
            ...
            table.put(new Integer(number),"rehash");
        }
        ...
        HashtableDoubleCoalesced<Integer,String> table100 = new HashtableDoubleCoalesced();
        HashtableDoubleCoalesced<Integer,String> table1000 = new HashtableDoubleCoalesced();
        HashtableDoubleCoalesced<Integer,String> table10000 = new HashtableDoubleCoalesced();
