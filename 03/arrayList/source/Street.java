...
public class Street{
    ...
    */
    ...
    private ArrayList<ArrayList<Construction>> stAr;
    private int lenght;
    ...
    */
    public Street(int len){
        ...
        ArrayList<Construction> stAr0 = new ArrayList<Construction>();
        ArrayList<Construction> stAr1 = new ArrayList<Construction>();
